...
export default function QuestionText({id,onRemove}) {
    return (
        <div className="flex flex-row items-center">
            ...
            <textarea id={id} rows={2} name={`survey.question`} className="bg-stone-800 outline outline-stone-700 text-stone-300 my-1 w-100 rounded-sm p-1 resize-none"></textarea>
